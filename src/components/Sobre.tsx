      ...
      <div className="max-w-4xl mx-auto relative">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-2/5 relative">
            ...
            />
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl px-6 py-4 shadow-lg border border-golden-100">
              <p className="font-display text-3xl font-medium text-bordeaux-600">+200</p>
              <p className="text-xs text-mauve-800 opacity-60 tracking-wide">clientes atendidas</p>
            </div>
          </div>
          ...
          <div className="w-full md:w-3/5">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-medium text-mauve-900 mb-8 leading-snug">
              Cuidado com a pele
              <br />
              <span className="italic text-bordeaux-600">que transforma</span>
            </h2>

            <p className="text-mauve-800 leading-relaxed mb-6 font-light opacity-80">
            ...
            <p className="text-mauve-800 leading-relaxed mb-10 font-light opacity-80">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={item.label} className="flex items-center gap-3">
                  <div className="w-px h-8 bg-golden-400" />
                  <div>
                    <p className="font-display text-2xl font-medium text-bordeaux-600">{item.numero}</p>
                    <p className="text-xs text-mauve-800 opacity-60">{item.label}</p>
                  </div>
                </div>
              ))}
            </div>
